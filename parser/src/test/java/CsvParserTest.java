...
public class CsvParserTest {
    ...
    void givenSingleRowReaderWhenParseReturnsOneRowObservable() {
        ...
        Observable<CsvPropertyObject> parsingResultObservable = parser.parseCsvToPropertyObject(new StringReader("1.5;2.5;3.5;4.5;5.5;att6;att7;att8"));
        parsingResultObservable.subscribe(parsedRow -> {
            ...
            assertEquals("att8", parsedRow.getAtt8());
        });
    }
}
